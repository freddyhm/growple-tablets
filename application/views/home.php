...
<div id="homePage">
	...
	<div class="sectionLinks" id="btn_intmenu">
		<img id="menuLink" class="navLink" src="<?php echo URL . 'public/img/home/btn_intmenu.png'; ?>">
	...
	<div class="sectionLinks" id="btn_games">
			<img id="gameLink" class="navLink" src="<?php echo URL . 'public/img/home/btn_game.png'; ?>">	
	...
	<div class="sectionLinks" id="btn_videos">
			<img id="videoLink" class="navLink" src="<?php echo URL . 'public/img/home/btn_video.png'; ?>">
