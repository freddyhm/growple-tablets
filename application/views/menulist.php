...
<div id="menuContent">
	...
	<table class="gridtable">
		...
		<tr>
			...
			<div style="font-size:13px; bottom:72px" class="gridName_selected" id="grid44">THE DOUBLE FISTED CHEESBURGER</div>
	...
	<div id="listInfoContent">
		<span class="itemName_list">THE DOUBLE FISTED CHEESEBURGER</span>	
		<div id="itemPicture_list"></div>
		<span class="itemDescription_list">Indulge in this delicious prime rib burger with our spice rub, bacon, melted cheddar cheese, sundried tomato mayo, lettuce, tomato, red onion and pickle. Served with fries on a fresh organic Grainharvest Breadhouse Farmer bun. Add any of the following for</span>
		<span class="itemPrice_list">$12.99</span>
		<img id="grabIt_list" src="<?php echo URL .'public/img/menu/common/btn_grab.png'; ?>">
