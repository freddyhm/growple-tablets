...
<div class='pop'>
	...
	<div class="unlove-selection">
		<div class="pop-overlay item-bckgd"></div>
		<div class="selection-pop">
			<div class='thanks-msg'><p>Thanks for the feeback!</p></div>
			<?php 
				foreach ($item_comments as $comment) {
			?>
				<button class="selection-btn item-answer" id="<?php echo $comment['id']; ?>"><?php echo $comment['name']; ?></button>
			<?php } ?>
				<button class="selection-btn pop-close"> Cancel </button>
		</div>	
	</div>
</div>
